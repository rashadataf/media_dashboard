...
function ListDegrees() {
  ...
  useEffect(() => {
    async function fetchDegrees() {
      let degrees = await AdminServices.degreesServices.fetchAll();
      setDegrees(degrees);
    }
  ...
  const handleDeleteConfirmation = async () => {
    try {
      const res = await AdminServices.degreesServices.deleteDegree(id);
      if (res) {
    ...
    <>
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <h2 id="simple-modal-title">Update Degree</h2>
