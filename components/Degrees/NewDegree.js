...
class NewDegree extends React.Component {
  state = {
    title: "",
    arTitle: "",
    titleError: "",
  ...
  handleSave = async () => {
    if (this.validateInput()) {
      const result = await AdminServices.degreesServices.createNewDegree(
        this.state.title,
        this.state.arTitle
      );
      if (result) {
...
export default withMyHook(NewDegree);
