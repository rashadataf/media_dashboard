...
class NewCollege extends React.Component {
  state = {
    title: "",
    arTitle: "",
    titleError: "",
  ...
  handleSave = async () => {
    if (this.validateInput()) {
      const result = await AdminServices.collegesServices.createNewCollege(
        this.state.title,
        this.state.arTitle
      );
      if (result) {
...
export default withMyHook(NewCollege);
