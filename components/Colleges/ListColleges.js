...
function ListColleges({ isConnected }) {
  ...
  useEffect(() => {
    async function fetchColleges() {
      let colleges = await AdminServices.collegesServices.fetchAll();
  ...
  const handleDeleteConfirmation = async () => {
    try {
      const res = await AdminServices.collegesServices.deleteCollege(id);
      if (res) {
    ...
    <>
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <h2 id="simple-modal-title">Update College</h2>
