...
function ListCountries() {
  ...
  useEffect(() => {
    async function fetchCountries() {
      let countries = await AdminServices.countriesServices.fetchAll();
  ...
  const handleDeleteConfirmation = async () => {
    try {
      const res = await AdminServices.countriesServices.deleteCountry(id);
      if (res) {
    ...
    <>
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <h2 id="simple-modal-title">Update Country</h2>
