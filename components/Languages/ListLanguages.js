...
function ListLanguages() {
  ...
  useEffect(() => {
    async function fetchLanguages() {
      let languages = await AdminServices.languagesServices.fetchAll();
  ...
  const handleDeleteConfirmation = async () => {
    try {
      const res = await AdminServices.languagesServices.deleteLanguage(id);
      if (res) {
    ...
    <>
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <h2 id="simple-modal-title">Update Language</h2>
