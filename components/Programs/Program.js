...
class Program extends React.Component {
  state = {
    ...
    titleError: "",
    arTitleError: "",
    years: this.props.years || 0,
    yearsError: "",
    normalPrice: this.props.normalPrice || 0,
    normalPriceError: "",
    discountPrice: this.props.discountPrice || 0,
    discountPriceError: "",
  ...
  handleUpdate = async () => {
    if (this.validateInput()) {
      const result = await AdminServices.programsServices.updateProgram(
        this.state._id,
        this.state.title,
        this.state.arTitle,
        this.state.years,
...
export default withMyHook(Program);
